        ...
        http
                ...
                .authorizeHttpRequests(
                        auth -> auth
                                ...
                                .requestMatchers(HttpMethod.GET,"/api/tools/findById").permitAll()
                                .requestMatchers(HttpMethod.GET,"/api/tools/findByName").permitAll()
                                .requestMatchers(HttpMethod.GET,"/api/tools/findAllByName").permitAll()
